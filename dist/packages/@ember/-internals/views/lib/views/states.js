import { t as teardownMandatorySetter } from '../../../../../shared-chunks/mandatory-setter-Bij6Bx8G.js';
...
const IN_DOM = Object.freeze({
  ...
  enter(view) {
    ...
    if (isDevelopingApp()) {
      ...
      (isDevelopingApp() && !(teardownMandatorySetter) && assert('[BUG] Expected teardownMandatorySetter to be set in DEBUG mode', teardownMandatorySetter));
