import { getOwner, setOwner } from '../../../owner/index.js';
import { e as enumerableSymbol } from '../../../../../shared-chunks/symbol-Bye5Bjw-.js';
import { g as guidFor } from '../../../../../shared-chunks/mandatory-setter-Bij6Bx8G.js';
import { addChildView, setViewElement, setElementView } from '../../../views/lib/system/utils.js';
import '../../../views/lib/system/action_manager.js';
import '../../../views/lib/views/states.js';
import { debugFreeze } from '../../../../debug/index.js';
import { _instrumentStart } from '../../../../instrumentation/index.js';
import { createPrimitiveRef, valueForRef, createComputeRef, childRefFor } from '../../../../../@glimmer/reference/index.js';
import { reifyPositional } from '../../../../../@glimmer/runtime/index.js';
import { EMPTY_ARRAY } from '../../../../../@glimmer/util/index.js';
import { unwrapTemplate } from './unwrap-template.js';
import { beginTrackFrame, endTrackFrame, beginUntrackFrame, endUntrackFrame, consumeTag, validateTag, valueForTag } from '../../../../../@glimmer/validator/index.js';
import { isTemplateFactory } from '../template.js';
import { createSimpleClassNameBindingRef, createClassNameBindingRef, parseAttributeBinding, installAttributeBinding } from '../utils/bindings.js';
import ComponentStateBucket from '../utils/curly-component-state-bucket.js';
import { processComponentArgs } from '../utils/process-args.js';
...
export { ARGS, BOUNDS, CURLY_CAPABILITIES, CURLY_COMPONENT_MANAGER, DIRTY_TAG, HAS_BLOCK, IS_DISPATCHING_ATTRS, CurlyComponentManager as default, initialRenderInstrumentDetails, isCurlyManager, processComponentInitializationAssertions, rerenderInstrumentDetails };
