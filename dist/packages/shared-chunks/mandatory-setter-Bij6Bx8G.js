...
if (isDevelopingApp()) {
  ...
  setupMandatorySetter = function (tag, obj, keyName) {
    ...
    Object.defineProperty(obj, keyName, {
      ...
      set(value) {
        (isDevelopingApp() && true && assert(`You attempted to update ${this}.${String(keyName)} to "${String(value)}", but it is being tracked by a tracking context, such as a template, computed property, or observer. In order to make sure the context updates properly, you must invalidate the property when updating it. You can mark the property as \`@tracked\`, or use \`@ember/object#set\` to do this.`));
      }
    });
  };
...
export { GUID_KEY as G, ROOT as R, getDebugName$1 as a, isObject as b, generateGuid as c, checkHasSuper as d, setListeners as e, setupMandatorySetter as f, guidFor as g, setWithMandatorySetter as h, intern as i, lookupDescriptor as l, observerListenerMetaFor as o, setObservers as s, teardownMandatorySetter as t, uuid as u, wrap as w };
