...
import { assign, assertNever, dict } from '../@glimmer/util/index.js';
...
import { trackLocals, isPath, isStringLiteral } from '../@ember/template-compiler/lib/plugins/utils.js';
...
var publicBuilder = {
  mustache: function (path, params = [], hash = buildHash([]), trusting = false, loc, strip) {
    return b.mustache({
      path: buildPath(path),
      params: params,
      hash: hash,
